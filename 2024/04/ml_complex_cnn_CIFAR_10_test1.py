...
transform_train = transforms.Compose([
    transforms.RandomCrop(32, padding=4),
    transforms.RandomHorizontalFlip(),
    transforms.RandomResizedCrop(32, scale=(0.8, 1.0)),  # Random scaling between 80% and 100% of the original size
...
torch.save(net.state_dict(), 'ml_complex_cnn_CIFAR_10_test1.pth')
